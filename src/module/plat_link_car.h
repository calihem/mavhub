#ifndef _PLAT_LINK_CAR_H_
#define _PLAT_LINK_CAR_H_
...
namespace mavhub {
  class Plat_Link_Car : public ModuleBase {
  public:
    Plat_Link_Car(const std::map<std::string, std::string> args);
    virtual ~Plat_Link_Car();
  ...
  private:
    ...
    mavlink_huch_ext_ctrl_t ext_ctrl;
    // debug structure
    mavlink_debug_t dbg;
